...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean itemSelected(int id, MenuItem item) {
        ...
        // parse all async
            ...
            builder.append("Hello emoji " + emojiString);
            builder.append(filterFromFile(tv_data, "\n\n\nHello apple " + emojiString, DemoUtils.getFolderPath() + "/img-apple-64/"));
            builder.append(filterFromFile(tv_data, "\n\n\nHello google " + emojiString, DemoUtils.getFolderPath() + "/img-google-64/"));
            builder.append(filterFromFile(tv_data, "\n\n\nHello twitter " + emojiString, DemoUtils.getFolderPath() + "/img-twitter-64/"));
            builder.append(filterFromFile(tv_data, "\n\n\nHello emojione " + emojiString, DemoUtils.getFolderPath() + "/img-emojione-64/"));
